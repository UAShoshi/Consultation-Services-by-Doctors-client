...
const Navbar = () => {
...

  {
      user?.email ?
        ...
        <details>
          ...
          <li onClick={handleLogout} className="btn bg-black text-white">
            Logout</li>
        </> : <Link to="/login">
  ...
  <div className="navbar-start">
    ...
    <img className="w-8" src="https://i.ibb.co/pjsQ1kv/c-logo.png" alt="" />
    <Link to='/' className="btn btn-ghost text-xl">Consultation Services by Doctors</Link>
  </div>
